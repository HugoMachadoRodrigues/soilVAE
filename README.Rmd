...
[![CRAN status](https://www.r-pkg.org/badges/version/soilVAE)](https://CRAN.R-project.org/package=soilVAE) [![R-CMD-check](https://github.com/HugoMachadoRodrigues/soilVAE/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/HugoMachadoRodrigues/soilVAE/actions/workflows/R-CMD-check.yaml) [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.187115457.svg)](https://doi.org/10.5281/zenodo.187115457) ![Python](https://img.shields.io/badge/Python-%3E%3D3.9-blue) ![TensorFlow](https://img.shields.io/badge/TensorFlow-%3E%3D2.13-orange)
...
```{r spectrum_plot, fig.alt="Raw reflectance spectra (datsoilspc$spc)", fig.cap="Raw reflectance spectra (datsoilspc$spc)"}
matplot(
...
```{r absorbance_plot, fig.alt="Absorbance spectra (datsoilspc$spcA)", fig.cap="Absorbance spectra (datsoilspc$spcA)"}
...
```{r preprocess_plot, fig.alt="Preprocessed spectra (datsoilspc$spcAMovav)", fig.cap="Preprocessed spectra (datsoilspc$spcAMovav)"}
...
```{r Splits, fig.alt="Calibration vs TEST splits (datC vs datV)", fig.cap="Calibration vs TEST splits (datC vs datV)"}
set.seed(19101991)
...
```{r pls_cv, fig.alt="PLS CV performance (datC)", fig.cap="PLS CV performance (datC)"}
maxc <- 30
...
```{r pls_pred, fig.alt="PLS predictions (datC + datV)", fig.cap="PLS predictions (datC + datV)"}
nc <- 14
...
```{r plotting_splits_VAE, fig.alt="Train/Val splits for soilVAE", fig.cap="Train/Val splits for soilVAE"}
