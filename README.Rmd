...
This follows the workflow style commonly used in soil spectral inference tutorials (e.g., Wadoux et al., 2021), with a direct comparison between a **PLS baseline** and **soilVAE**.
